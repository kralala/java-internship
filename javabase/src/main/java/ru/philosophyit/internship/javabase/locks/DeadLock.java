...
public class DeadLock {
    ...
    // interruption позволяет прервать потоки в ситуации их взаимной блокировки
    // interruptedexception выбрасывается, когда прерывается занятый поток, в т.ч. заблоченный
